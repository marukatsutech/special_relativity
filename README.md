...
If the magnitudes of rotation vectors A, B, and C are constant, the resultant rotation vector of rotation vectors A, B, and C indicates a constant direction. Elementary particles (A-axis, B-axis, and C-axis representing the internal coordinate axes of elementary particles) rotate at a constant speed around the resultant rotation vector. The rotation vector is not oscillating, but this case is called vibration mode I.
