...
def update_diagram():
    global theta0, qvr_phase0, c_upper0_guide, line_phase0_guide, line_phase1_guide
    global line_phase1_projection, line_phase1_projection_guide, projection_point
    global theta1, qvr_phase1, qvr_phase_composite
    ...
    r = np.tan(theta0_rad)
    c_upper0_guide = Circle((0., 0.), r, ec='darkorange', fill=False, linewidth=1, linestyle='--')
    ...
    qvr_phase_composite = ax0.quiver(x2, y2, z2, u2, v2, w2, length=1, color='red', linewidths=0.5, normalize=True,
...
ax0.add_patch(c_upper0_guide)
art3d.pathpatch_2d_to_3d(c_upper0_guide, z=1, zdir="z")
line_upper0_radius = art3d.Line3D([0., 0.], [0., 0.], [0., 0.], linewidth=0.5, color='darkorange', ls="-.")
...
line_phase1_projection_guide = art3d.Line3D([0., 0.], [0., 0.], [1., 1.], linewidth=1, color='green', ls="--")
...
parabola = art3d.Line3D(x_parabola, y_parabola, z_parabola, color='green', ls="--", linewidth=1)
...
ax0.plot(x_phase_composite, y_phase_composite, z_phase_composite, linewidth=0.5, linestyle=':', c='red',
         label='Normalized')
ax0.plot(x_phase_composite / norm_phase_composite, y_phase_composite / norm_phase_composite,
         z_phase_composite / norm_phase_composite, linewidth=0.5, linestyle='--', c='red', label='Not normalized')
